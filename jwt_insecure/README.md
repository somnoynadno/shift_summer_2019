...
7.None
По большей части уязвимость jwt токенов заключается в использовании класса none для аутентификции и к тому что все токены можно свести к нему.
...
## Защита
### Основные меры
Branca - Более хорошее шифрование   
